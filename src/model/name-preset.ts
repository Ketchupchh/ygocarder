...
export const createPresetNameStyle = (
  presetValue: Partial<NameStyle>
): Partial<NameStyle> => ({
  hasGradient: false,
  hasOutline: false,
  hasShadow: false,
...
export type PresetNameStyle =
  ...
  | "embossGold"
  | "embossPlatinum";
export const PresetNameStyleMap: Record<
  PresetNameStyle,
  {
    key: PresetNameStyle;
    label: string;
...
> = {
  ...
  animeRed: {
    ...
    value: createPresetNameStyle({
      ...
      gradientAngle: 180,
      gradientColor:
        "0.000|#d81961,0.220|#b81654,0.270|#9e1348,0.330|#95093e,0.380|#95093e,0.450|#ba3264,0.530|#ff5e99,0.620|#ffa0c3,0.690|#ffffff,0.770|#ff5e99,0.870|#d81961,1.000|#b81654",
      hasGradient: true,
      hasOutline: true,
      hasShadow: true,
      lineColor: "#333333",
  ...
  animeSilver: {
    ...
    value: createPresetNameStyle({
      ...
      gradientAngle: 180,
      gradientColor:
        "0.000|#cecbb8,0.220|#b0ad9b,0.270|#94917e,0.330|#797768,0.380|#797768,0.450|#d9d9d9,0.610|#ffffff,0.700|#ffffff,0.870|#d6d7c7,1.000|#c9cbb6",
      hasGradient: true,
    }),
  },
  animeGold: {
    ...
    value: createPresetNameStyle({
      ...
      gradientAngle: 180,
      gradientColor:
        "0.000|#eee317,0.220|#dbbe15,0.270|#d0920c,0.330|#b57f0b,0.380|#d0920c,0.450|#ffff6b,0.610|#ffffff,0.700|#ffffff,0.870|#e5dd2d,1.000|#e3da23",
      hasGradient: true,
    }),
  },
  promo: {
