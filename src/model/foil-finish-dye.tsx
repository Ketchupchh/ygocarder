...
type FinishInstruction = {
  opacity?: number;
  blendMode?: GlobalCompositeOperation;
};
const type3CommonInstruction: FinishInstruction[] = [
...
export const FinishMap: Record<string, FinishInformation> = {
  ...
  type7: {
    ...
    partInstructionMap: {
      "total-overlay": [
        { blendMode: "screen", opacity: 0.175 },
        { blendMode: "color-dodge", opacity: 0.125 },
      ],
    },
    pendulumSubstituteMap: {},
  },
...
export const ArtFinishMap: Record<string, FinishInformation> = {
  ...
  type3: {
    ...
    partInstructionMap: {
      art: [
        { opacity: 0.66, blendMode: "color-dodge" },
        { opacity: 0.64, blendMode: "multiply" },
      ],
    },
    pendulumSubstituteMap: {
      small: "",
  ...
  type4: {
    ...
    partInstructionMap: {
      art: [
        { opacity: 0.31, blendMode: "color-dodge" },
  ...
  type5: {
    ...
    partInstructionMap: {
      art: [
        { opacity: 0.19, blendMode: "color-dodge" },
        { opacity: 0.6, blendMode: "multiply" },
      ],
    },
    pendulumSubstituteMap: {
  ...
  type6: {
    ...
    partInstructionMap: {
      art: [
        { opacity: 0.25, blendMode: "color-dodge" },
        { opacity: 0.6, blendMode: "multiply" },
      ],
    },
    pendulumSubstituteMap: {
...
export const getDefaultDyeList = () =>
  ["", "", "", "", "", "", ""] as FrameDyeList;
