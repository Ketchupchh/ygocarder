...
export const FlagPresentationList = [
  {
    ...FlagInfoList[0],
    valueDisplay: (language: LanguageDataDictionary, _value: number) =>
    ...
    sampleDisplay: (language: LanguageDataDictionary) => (
      <>
        ...
        <ul>
          <li>
            <CopiableCode data={0}>0</CopiableCode>:{" "}
            {language["manager.template.description.true"]}
          </li>
          <li>
            <CopiableCode data={1}>1</CopiableCode>:{" "}
            {language["manager.template.description.false"]}
          </li>
        </ul>
      </>
    ),
      ...
      <>
        ...
        <ul>
          <li>
            ...
            : {language["input.flag.link-rating-behavior.auto"]}
          </li>
          <li>
            <CopiableCode data={LINK_RATING_ALWAYS_SHOW}>
              {LINK_RATING_ALWAYS_SHOW}
            </CopiableCode>
            : {language["input.flag.link-rating-behavior.show"]}
          </li>
          <li>
            <CopiableCode data={LINK_RATING_ALWAYS_HIDE}>
              {LINK_RATING_ALWAYS_HIDE}
            </CopiableCode>
            : {language["input.flag.link-rating-behavior.hide"]}
          </li>
        </ul>
      </>
    ),
