...
import {
  ...
  BackgroundInputGroupRef,
} from "./background-input-group";
import {
...
export type LayoutPicker = {
  ...
  ImageCropper,
  "receivingCanvas" | "onTainted" | "onCropChange" | "onSourceLoaded"
>;
...
export const LayoutPicker = forwardRef<OpacityPickerRef, LayoutPicker>(
  (
    ...
    const changeBackgroundType = useMemo(
      () => getUpdater("backgroundType"),
      [getUpdater]
    );
    const changeHasBackground = useCallback(
      (e: any) =>
        setCard((currentCard) => {
    ...
    useImperativeHandle(ref, () => ({
      ...
      setValue: ({
        ...
        if (
          ...
          backgroundInputRef.current?.setValue({
            background,
            backgroundCrop,
            backgroundData,
            backgroundSource,
        ...
        for (const key in newValue) {
          if (
            newValue[key as keyof CardOpacity] !==
            opacity[key as keyof CardOpacity]
          ) {
            setOpacity((cur) => {
              return { ...cur, ...newValue };
            });
    ...
    return (
      <StyledLayoutPickerContainer className="card-opacity-slider-container">
        <Tooltip
            ...
            <div className="overlay-event-absorber">
              ...
              >
                ...
                >
                  ...
                  >
                    {language["input.background.toggle-label"]}
                  </Checkbox>
                  <br />
                ...
                <div
                  className={`background-picker ${
                    hasBackground ? "" : "overlay-no-background"
                  }`}
                >
                  <BackgroundInputGroup
                  ...
                  >
                    <div className="layout-picker-panel">
                      ...
                      {!noBackground && (
                        <div className="layout-picker-subpanel type-section">
                          ...
                          <RadioTrain
                            ...
                            optionList={getBackgroundTypeList({
                              ...
                              full: language[
                                "input.background-type.full.label"
                              ],
                              frame:
                                language["input.background-type.frame.label"],
                            })}
          ...
          return (
            ...
            >
              <SolidLabel className="slider-label">
                {activable && (
                  <Tooltip
                    title={tooltipKey ? language[tooltipKey] ?? null : null}
                    overlayClassName="long-tooltip-overlay"
                  >
                    <Checkbox
                      checked={isActive}
              ...
              <InputNumber
                ...
                onChange={(value) =>
                  setOpacity((cur) => ({
                    ...cur,
                    [type]: typeof value === "number" ? value : 100,
                  }))
                }
